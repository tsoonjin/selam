...
** TODO Implement automatic machine learning    
...
** TODO Selecting object representation scheme
...
**** Sparse Coding
**** Clustering
** TODO Adding prior to detection
*** background/context prior, shape prior
** TODO Use detection free tracking technique
